...
<br><br><br>   <center><h3>Developer Login</h3></center>
           <form class="box login" action="DevLogin" method="post">
             <fieldset class="boxBody">             
                ...
                <!--input type="text" name="utype" value="devlop" style="visibility:hidden;"-->
             </fieldset>
            <center>            
